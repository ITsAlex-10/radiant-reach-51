...
const SobreNos = () => {
  return <>
      <Helmet>
        ...
        <meta name="description" content="Conheça a história da Joaquim & Fernandes. Desde 1995 a prestar serviços de eletricidade de qualidade em Portugal. Equipa experiente e certificada." />
          ...
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              duration: 0.6
                ...
                <img src="https://images.unsplash.com/photo-1581092335397-9583eb92d232?w=800&h=600&fit=crop" alt="Equipa Joaquim & Fernandes" className="relative rounded-2xl shadow-2xl border-4 border-[#A7D1EC]/30" />
