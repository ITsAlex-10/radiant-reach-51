          ...
          <div className="container-custom">
            <div className="grid grid-cols-4 gap-4">
              <motion.div
                ...
                viewport={{ once: true }}
                className="aspect-video rounded-xl overflow-hidden border-2 border-[#A7D1EC]/30"
              >
                <img 
                  src="https://images.unsplash.com/photo-1581092335397-9583eb92d232?w=400&h=250&fit=crop" 
                  alt="Equipa técnica"
              ...
              >
                <img 
                  src="https://images.unsplash.com/photo-509391366360-2e959784a276?w=400&h=250&fit=crop" 
                  alt="Energia solar"
                  className="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                />
              </motion.div>
        ...
        <section className="py-16 bg-primary relative overflow-hidden">
          ...
          <div className="container-custom text-center relative z-10">
            ...
            <Button
              ...
              size="lg"
              className="bg-[#A7D1EC] text-primary hover:bg-[#A7D1EC]/90"
            >
              <Mail size={18} className="mr-2" />
