...
const benefits = [
  { title: "Eficiência Energética", description: "Redução significativa do consumo de energia através de automação e gestão inteligente.", icon: Zap },
  { title: "Sustentabilidade", description: "Menor pegada de carbono e melhor gestão dos recursos naturais.", icon: TreePine },
  { title: "Qualidade de Vida", description: "Cidades mais seguras, limpas e acessíveis para todos os cidadãos.", icon: Shield },
  { title: "Gestão em Tempo Real", description: "Monitorização e controlo centralizado de todos os sistemas urbanos.", icon: Gauge },
];
      ...
      <main>
        ...
        <section className="relative bg-primary text-white pt-32 pb-24 overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#A7D1EC]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                <Building2 className="w-5 h-5 text-[#A7D1EC]" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                {benefits.map((benefit, index) => (
                  <div 
                    key={benefit.title}
                    className="p-5 bg-white rounded-xl border border-[#A7D1EC]/20 hover:shadow-lg hover:shadow-[#A7D1EC]/10 transition-all duration-300"
                  >
        ...
        <section className="py-12 bg-[#A7D1EC]/10">
          <div className="container-custom">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                <img 
                  src="https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=400&h=400&fit=crop" 
                  alt="IoT e conectividade"
                  className="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                />
              </motion.div>
            </div>
