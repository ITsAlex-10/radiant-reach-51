...
const benefits = [
  { icon: Award, text: "Experiência desde 1986" },
  { icon: Users, text: "Equipa Técnica Certificada" },
  { icon: Shield, text: "Soluções Chave-na-mão" },
  { icon: Clock, text: "Apoio 24/7" },
];

const Benefits = () => {
  return (
    <section className="section-padding bg-gradient-to-br from-[#F5F5F5] to-[#A7D1EC]/10 relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-8 right-8 w-32 h-32 rounded-xl overflow-hidden border-4 border-white shadow-lg z-20 hidden md:block"
            >
              <img
