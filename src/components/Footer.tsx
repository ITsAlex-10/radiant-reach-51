...
const Footer = () => {
  return <footer className="bg-primary text-white relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <img src={logo} alt="Joaquim & Fernandes Logo" className="w-16 h-16 rounded-full object-cover border-2 border-[#A7D1EC]/30" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Início
                </Link>
              </li>
              <li>
                <Link to="/sobre-nos" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Sobre Nós
                </Link>
              </li>
              <li>
                <Link to="/servicos" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Serviços
                </Link>
              </li>
              <li>
                <Link to="/parceiros" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Parceiros
                </Link>
              </li>
              <li>
                <Link to="/contacto" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/servicos#projetos" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Projetos Elétricos
                </Link>
              </li>
              <li>
                <Link to="/servicos#instalacoes" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Instalações
                </Link>
              </li>
              <li>
                <Link to="/servicos#postos-carregamento" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Mobilidade Elétrica
                </Link>
              </li>
              <li>
                <Link to="/smart-cities" className="text-white/80 hover:text-[#A7D1EC] transition-colors duration-300">
                  Smart Cities
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@joaquimfernandes.pt" className="text-white/80 hover:text-[#A7D1EC] transition-colors">
