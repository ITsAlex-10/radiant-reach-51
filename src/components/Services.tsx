...
const Services = () => {
  return <section id="servicos" className="section-padding bg-background">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          delay: index * 0.1
              ...
              <Link to={service.link} className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-accent transition-colors uppercase tracking-wider">
                Saber mais
