...
const Services = () => {
  return <section id="servicos" className="section-padding bg-background relative overflow-hidden">
      {/* Decorative Elements */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          delay: index * 0.1
              ...
              <div className="p-6">
                ...
                <Link to={service.link} className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-[#A7D1EC] transition-colors uppercase tracking-wider group-hover:gap-3">
                  Saber mais
