...
const CTASection = forwardRef<HTMLElement, CTASectionProps>(function CTASection({
  isLitUp = false
}, ref: ForwardedRef<HTMLElement>) {
  return <section ref={ref} className="py-20 relative overflow-hidden transition-all duration-1000" style={{
    backgroundColor: isLitUp ? 'hsl(var(--primary))' : '#1a1a2e'
      ...
      duration: 1
        ...
        <motion.div className="absolute inset-0 bg-black/60" animate={{
      ...
      duration: 0.8
        ...
        <motion.div className="absolute top-0 left-0 w-96 h-96 bg-[#A7D1EC]/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl" animate={{
      opacity: isLitUp ? 1 : 0,
      scale: isLitUp ? 1 : 0.5
    }} transition={{
      duration: 0.8,
      delay: 0.2
        ...
        <motion.div className="absolute bottom-0 right-0 w-72 h-72 bg-[#A7D1EC]/15 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl" animate={{
      opacity: isLitUp ? 1 : 0,
      scale: isLitUp ? 1 : 0.5
    }} transition={{
      duration: 0.8,
      delay: 0.3
        ...
        <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-32 bg-[#A7D1EC]/10 blur-3xl" animate={{
      opacity: isLitUp ? 1 : 0
    }} transition={{
      duration: 0.8,
      delay: 0.4
        ...
        <motion.div className="absolute inset-0 bg-[#A7D1EC]/40 pointer-events-none" initial={{
      opacity: 0
    }} animate={{
      ...
      times: [0, 0.3, 1]
        ...
        duration: 0.8
            ...
            <motion.h2 className="text-3xl md:text-4xl lg:text-5xl text-white mb-4" animate={{
          ...
          duration: 0.8
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 justify-center" animate={{
          ...
          delay: 0.4
              ...
              <div className="flex items-center gap-2 text-white/70">
                <motion.div className="w-2 h-2 rounded-full bg-[#A7D1EC]" animate={{
